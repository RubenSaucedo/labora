...
Use `resume-conventions`, `resume-interview`, and `resume-writing` before drafting.
...
4. Review the draft yourself for obvious scope inflation, vague placeholders, and section placement.
